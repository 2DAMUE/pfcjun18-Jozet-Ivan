    ...
    private static void processChanges(String changes) {
        if (changes.equalsIgnoreCase("gas")) {
            ...
            if (dispositivoNew.getLight().getState().equalsIgnoreCase("on")) {
                nh.showNotification(Constantes.CHANNEL_LIGHT_ID, "Luz", "¡Alguien encendió la luz!", Constantes.CHANNEL_LIGHT, R.mipmap.light_on_notification_icon, true);
            }
            else if (dispositivoNew.getLight().getState().equalsIgnoreCase("off")) {
                nh.showNotification(Constantes.CHANNEL_LIGHT_ID, "Luz", "¡Alguien apagó la luz!", Constantes.CHANNEL_LIGHT, R.mipmap.light_off_notification_icon, true);
            }
            ...
            if (dispositivoNew.getPlug().getState().equalsIgnoreCase("on")) {
                nh.showNotification(Constantes.CHANNEL_PLUG_ID, "Enchufe", "¡Alguien activó el enchufe!", Constantes.CHANNEL_PLUG, R.mipmap.connected_icon, true);
            }
            else if (dispositivoNew.getPlug().getState().equalsIgnoreCase("off")) {
                nh.showNotification(Constantes.CHANNEL_PLUG_ID, "Enchufe", "¡Alguien desactivó el enchufe!", Constantes.CHANNEL_PLUG, R.mipmap.disconnected_icon, true);
            }
